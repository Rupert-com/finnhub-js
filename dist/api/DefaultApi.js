...
export default class DefaultApi {
  ...
  */
  ...
  aggregateIndicator(symbol, resolution, callback) {
    let postBody = null; // verify the required parameter 'symbol' is set
  ...
  bondPrice(isin, from, to, callback) {
    let postBody = null; // verify the required parameter 'isin' is set
  ...
  cryptoSymbols(exchange, callback) {
    let postBody = null; // verify the required parameter 'exchange' is set
  ...
  filingsSentiment(accessNumber, callback) {
    let postBody = null; // verify the required parameter 'accessNumber' is set
  ...
  investmentThemes(theme, callback) {
    let postBody = null; // verify the required parameter 'theme' is set
  ...
  marketNews(category, opts, callback) {
    opts = opts || {};
    let postBody = null; // verify the required parameter 'category' is set
  ...
  symbolSearch(q, callback) {
    let postBody = null; // verify the required parameter 'q' is set
  ...
  technicalIndicator(symbol, resolution, from, to, indicator, opts, callback) {
    opts = opts || {};
    let postBody = opts['indicatorFields']; // verify the required parameter 'symbol' is set
